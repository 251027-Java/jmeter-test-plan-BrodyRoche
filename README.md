...
1. What was the average response time? 505ms
2. What was the throughput (requests/second)? 9.9/sec
3. Did any requests fail? No
4. Which endpoint was slowest? GET/delay/1
